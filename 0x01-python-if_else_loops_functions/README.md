...
With the help of 'if', 'if... else', 'break', 'continue', 'pass', and 'range' statements together with 'while' and 'for' loops, I started using conditionals and loops in Python for this project. I worked on building my own Python functions while studying arithmetic operators, tracebacks, and variable scope.
