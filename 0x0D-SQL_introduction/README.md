...
We started using relational databases in this project. I began experimenting with subqueries, functions, and basic SQL data definitions and data manipulation language.
